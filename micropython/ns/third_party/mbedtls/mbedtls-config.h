...
#if NS_ENABLE_BORDER_AGENT || NS_ENABLE_COMMISSIONER || NS_ENABLE_APPLICATION_COAP_SECURE
#define MBEDTLS_SSL_COOKIE_C
#define MBEDTLS_SSL_SRV_C
#endif

#if NS_ENABLE_APPLICATION_COAP_SECURE
...
#if NS_ENABLE_MULTIPLE_INSTANCES
#define MBEDTLS_PLATFORM_STD_CALLOC      ns_plat_calloc /**< Default allocator to use, can be undefined */
#define MBEDTLS_PLATFORM_STD_FREE        ns_plat_free /**< Default free to use, can be undefined */
#else
